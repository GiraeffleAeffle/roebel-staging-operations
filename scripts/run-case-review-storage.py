...
def main():
    ...
    parser.add_argument('--mode', choices=('plan', 'advance'), required=True)
    ...
    if args.mode == 'plan':
        if any((args.expected_plan_sha256, args.kubeconfig, args.receipt, args.prior_receipt, args.expected_prior_sha256)):
